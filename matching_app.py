...
def matching_app():
    ...
    def show_tutorial():
        ...
        tutorial_steps = [
            ...
            "widget": lambda: st.text_input("Gib deinen OpenAI API-Schlüssel ein", type="password")},
            ...
            "widget": lambda: st.selectbox("Wähle das Modell", ["gpt-4o", "gpt-4o-mini", "gpt-3.5-turbo"])},
            ...
            "widget": lambda: st.slider("Batchgröße", min_value=2, max_value=50, value=10, step=2)},
            {"title": "Schritt 4: Spracheinstellungen", 
            "content": "Wähle die Ausgangs- und Zielsprache deiner Übersetzung.\n", 
            "widget": lambda: (st.selectbox("Ausgangssprache", ["English", "German", "French", "Spanish", "Italian", "Polish"]), 
                            st.selectbox("Zielsprache", ["German", "English", "French", "Spanish", "Italian", "Polish"]))},
            ...
            "widget": lambda: (st.text_input("Befragtengruppe auf Englisch eingeben, z.B. 'Dentists'"), 
                            st.text_input("Thema der Befragung auf Englisch eingeben, z.B. 'Dental hygiene'"))},
            ...
            "widget": lambda: st.text_area("Beschreibe hier in 1-2 Sätzen das Ziel und das Thema des Fragebogens auf Englisch.", height=100)},
